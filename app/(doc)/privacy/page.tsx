      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Card className="mt-8">
          ...
          <CardContent className="prose dark:prose-invert max-w-none">
            ...
            <li>
            <p><strong>Us</strong> means XMUM Database Operation Team.</p>
            </li>
            <li>
            <p><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where &quot;control&quot; means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</p>
            </li>
            <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to XMUM Database Team.</p>
            </li>
            <li>
            ...
            <li>
            <p><strong>Service</strong> refers to the functions that Website can provide.</p>
            </li>
            <li>
            ...
            <li>
            <p><strong>Website</strong> refers to XMUM Database, accessible from <a href="..." rel="external nofollow noopener" target="_blank">XMUM Database.</a></p>
            </li>
            <li>
            <p><strong>Internal</strong> means if and only if the range of the XMUM Campus.</p>
            </li>
            <li>
            <p><strong>External</strong> means the range just except XMUM Campus.</p>
            </li>
            <li>
            <p><strong>You</strong> means the Internal individual accessing or using the Service.</p>
            </li>
            </ul>
